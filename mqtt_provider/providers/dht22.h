...
class Dht22 : public Provider
{
public:
class TemperatureReader : public Reader<double>
{
public:
...
class HumidityReader : public Reader<double>
{
public:
    ...
    virtual Reader<double> *getReaderForFloat(const std::string &name) override;
